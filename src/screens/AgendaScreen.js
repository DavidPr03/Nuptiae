...
import { Menu, Calendar as CalendarIcon, CheckSquare, Briefcase, Plus, ArrowLeft, Users, ShoppingCart, DollarSign } from "lucide-react-native";
    ...
    <SafeAreaView style={styles.safeArea} edges={["top", "left", "right"]}>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Agenda</Text>
          {["tareas", "calendario", "preparativos"].includes(selectedTab) && (
          ...
          {selectedTab === "calendario" && (
            <View style={styles.section}>
              ...
              <View style={styles.responsableCard}>
                ...
                <Text style={styles.responsableName}>Alfredo</Text>
              </View>
            </View>
          )}
